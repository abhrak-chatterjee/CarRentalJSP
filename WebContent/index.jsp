...
<!-- Start Switcher -->
<jsp:include page="includes/colorswitcher.jsp" />
<!-- /Switcher -->  
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Assess Your Needs. The "right car" depends on who you are and what you expect from a car. Set Your Budget. Decide If You Want to Lease or Buy. Leasing. Consider Other Cars in the Class. Weigh the Costs of Ownership. Find Cars for Sale. Set Up a Test Drive.</p>
    </div>
    <div class="row"> 
